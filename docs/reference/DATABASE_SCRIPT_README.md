...
- `schema.sql`：MySQL 8 兼容核心表结构，包含 `app_user`、`admin`、`car_model`、`car_param`、`car_feature_score`、`user_demand`、`recommend_record`、`recommend_item`、`user_favorite`、`recommend_feedback`。
- `seed-data.sql`：默认演示用户、默认演示管理员、120 条车型基础数据和 120 条车型参数数据。
